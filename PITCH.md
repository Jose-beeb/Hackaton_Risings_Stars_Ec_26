...
4. **Nueva investigación de una compañera del equipo** (`docs/research/Nathy Research.pdf`, movida ahí en la reorganización de carpetas — ver `docs/research/README.md`): trae dos citas nuevas confirmadas (Setha 2016, eficacia del Bti; Thalagala 2016, costo de hospitalización) y una sin confirmar (Zimmermann 2024). También trae parámetros bioclimáticos (aceleración del ciclo por El Niño, punto de 35°C) que **todavía no están en el código** de `ire_calculator.py` — no decir en el pitch que el sistema ya calcula eso. Detalle completo en la tabla de cifras y en la sección de Estado de avance.
...
| Casos de dengue Ecuador 2023 (27.838) vs. 2024 (61.329, +120%), 76 muertes | `research/Jose.md`, respaldado por boletines oficiales MSP Ecuador (SIVE-Alerta, salud.gob.ec) y cobertura de prensa que los cita directamente | ✅ Verificado en esta sesion — confirmado con fuente oficial, no solo la sintesis de Perplexity. **Nota:** `docs/research/Nathy Research.pdf` cita **61.352** para 2024 (vs. 61.329 en Jose.md/MSP) — diferencia menor, probablemente un redondeo o un corte de fecha distinto del boletin; usar 61.329 (el que tiene el link directo al boletin MSP) y no mezclar los dos numeros en la misma presentacion |
| Datos parciales 2025: 5.507 casos confirmados hasta semana epidemiologica 06, 4 muertes en ese periodo | `docs/research/Nathy Research.pdf` | ⚠️ No se busco la fuente primaria puntual en esta sesion, pero es coherente con la tendencia de los boletines MSP ya verificados — util para mostrar que el problema sigue escalando en 2025, no solo fue un pico de 2024 |
...
| Costo de hospitalizacion USD 866-1.855 atribuido a "Zimmermann 2024" | `docs/research/Nathy Research.pdf` | ⚠️ No pude confirmar una publicacion de Zimmermann (2024) con esos numeros — el limite inferior coincide con Thalagala 2016, el superior no lo pude verificar. Usar el rango de Thalagala (confirmado) en vez de este si preguntan por la fuente |
