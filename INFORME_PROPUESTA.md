...
- Refinamientos bio-climáticos sugeridos por `research/papers/Nathy Research.pdf` (aceleración del ciclo por anomalía tipo El Niño, punto de calibración a 35°C) y tope de carga por mochila de brigadista (5kg/14L) — ninguno está en el código todavía; el umbral de 8.3°C sí está implementado
...
- **Base científica del modelo IRE y papers de respaldo:** `research/papers/` (ver `research/README.md` — incluye Rueda 1990, Tun-Lin 2000, Doeurk 2025, y la investigación de contexto técnico de una compañera del equipo)
- **Resumen consolidado de toda la investigación, listo para sacar contenido de diapositivas:** `research/RESUMEN_INVESTIGACION.md`
